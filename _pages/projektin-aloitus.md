...
Lisää yllä oleva server-block tähän tiedostoon.
...
Tallenna näppäinyhdistelmällä <kbd><kbd>ctrl</kbd> <span>+</span> <kbd>O</kbd></kbd> ja poistu <kbd><kbd>ctrl</kbd> <span>+</span> <kbd>X</kbd></kbd>. Seuraavaksi testaa että konffi on oikein:
